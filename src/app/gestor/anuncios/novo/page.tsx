...
export default function NovoAnuncioPage() {
    ...
    const [formData, setFormData] = useState({
        ...
        state: "SP",
        address: "",
        lat: -23.55052, // Default Sao Paulo
        lng: -46.633308,
        price: "",
        maxGuests: "",
        whatsapp: "",
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const { addProperty } = await import("@/lib/data/properties");
            ...
            <div className="max-w-5xl mx-auto px-6 py-8">
                <div className="mb-8">
                    ...
                    <p className="text-gray-600">
                        Preencha as informações da sua propriedade para começar a receber reservas
                    </p>
                </div>
